...
module.exports = function (grunt) {
    grunt.initConfig({
        ...
        concat: {
            ...
            app: {
                // src: ['application/src/js/**/*.js', 'application/src/js/*.js'],
                src: jsScripts,
                dest: 'application/dist/static/js/app.js'
            },
            final: {
                src: jsFinal,
                dest: 'application/src/temp/js/final.js'
            }
        },
        uglify: {
            options: {
            ...
            libs: {
                files: {
                    'application/dist/static/js/libs.min.js': jsLibs
                }
            },
            final: {
                files: {
                    'application/dist/static/js/scripts.min.js': jsFinal
                },
        ...
        less: {
            app: {
                ...
                files: {
                    'application/dist/static/css/app.css': ['application/src/less/main.less']
                }
            },
            final: {
                options: {
                ...
                files: {
                    'application/src/temp/css/app.css': ['application/src/less/main.less']
                }
            }
        },
        concat_css: {
            ...
            libs: {
                src: cssLibs,
                dest: 'application/src/temp/css/libs.css'
            },
            final: {
                src: [
                    'application/src/temp/css/libs.css',
                    'application/src/temp/css/app.css'
                ],
                dest: 'application/src/temp/css/final.css'
            }
        },
        cssnano: {
            options: {
            ...
            libs: {
                files: {
                    'application/dist/static/css/libs.min.css': 'application/src/temp/css/libs.css'
                }
            },
            final: {
                files: {
                    'application/dist/static/css/final.min.css': 'application/src/temp/css/final.css'
                }
            }
        },
        copy: {
                ...
                files: [
                    {
                        ...
                        // dest: 'application/dist/templates'
                        dest: 'application/dist'
                    },
                    {
                        expand: true,
        ...
        processhtml: {
            final: {
                ...
                files: {
                    'application/dist/templates/index.html': ['application/src/index.html']
                }
            }
        },
        watch: {
            styles: {
                files: ['application/src/less/*.less', 'application/src/less/*/*.less'],
                tasks: ['less:app', 'notify:watch']
            },
            // scripts: {
            //     files: ['application/src/js/*.js', 'application/src/js/*/*.js'],
            //     tasks: ['concat:app', 'notify:watch']
            // },
            // html: {
            //     files: ['application/src/index.html', 'application/src/templates/*.html'],
            //     tasks: ['copy:html', 'notify:watch']
            // },
            // json: {
            //     files: ['application/src/JSON/*.json'],
